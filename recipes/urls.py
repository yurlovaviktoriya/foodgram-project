...
from . import views
from .proccessors.get_pdf import generate_pdf
...
urlpatterns = [
    ...
    path(
        'recipe/<str:username>/<int:recipe_id>/',
        views.recipe_view,
        name='recipe'
    ),
    path(
        'recipe/<str:username>/<int:recipe_id>/edit/',
        views.recipe_edit,
        name='recipe_edit'
    ),
    path(
        'recipe/<str:username>/<int:id>/delete/',
        views.delete_recipe,
        name='recipe_delete'
    ),
    ...
    path(
        'purchase/<str:username>/<int:id>/delete/',
